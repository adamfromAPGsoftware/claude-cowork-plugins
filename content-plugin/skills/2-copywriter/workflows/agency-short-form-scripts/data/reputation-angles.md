...
Use these facts to ground Reputation scripts. Never oversell — drop one fact naturally inside the body, not a list.

| Anchor | Phrasing Options |
|--------|-----------------|
...
**Hook:** "SaaS pricing is collapsing live and most SME owners haven't noticed yet."
**Underlying POV:** Per-user pricing was the 2015–2020 model. The category is bifurcating: all-in-one flat-fee platforms vs enterprise behemoths. Mid-market SaaS is getting squeezed out. SMEs who locked in per-user tools are overpaying for platforms they'll be forced to migrate off anyway.
**Evidence to pull:** HubSpot share price, Salesforce growth slowdown, category consolidation stats.
**Credibility tie:** "I've seen this shift from 300+ audits — the middle is disappearing."
...
### Take 04 — The Tools That Got You to $1M Will Break You at $5M
...
### Take 05 — Per-User Pricing Punishes Success

**Hook:** "Most SaaS tools are designed to penalise you for growing. And most business owners don't realise it until it's too late."
**Underlying POV:** Per-user pricing is a tax on growth. Every hire increases SaaS costs before they generate revenue. At 50 staff, a $50/user/month tool costs $30K/year more than it did at 10 staff.
**Evidence to pull:** Per-user cost escalation math from agency-offer.md ROI section.
**Credibility tie:** "I've seen CRM bills go from $400/mo to $2,100/mo just because the team grew."
...
### Take 07 — HubSpot's Share Price Dropped 40% — Here's What It Means
...
### Take 11 — The SMEs That Win With AI All Have the Same Thing in Common

**Hook:** "I've audited businesses that are flying with AI and businesses drowning in it. The difference isn't the tool — it's one thing."
**Underlying POV:** Clean, unified data. Businesses with a single source of truth for customer data, project data, and financial data can apply AI anywhere. Businesses with fragmented data get AI hallucinations, unreliable outputs, and eventually give up.
**Evidence to pull:** AI pillar — Pinecone semantic search, custom AI agents, N8N integration.
**Credibility tie:** "In every audit, I can tell within the first 30 minutes whether a business is AI-ready."

---

### Take 12 — The $3K Audit Is the Cheapest Due Diligence a Business Owner Can Do

**Hook:** "Most business owners spend $3,000 on a software subscription and never question the ROI. We charge the same amount to find you $5K a month in savings — or we give it back."
**Underlying POV:** Reframing the audit as the cheapest due diligence available. The price comparison to a monthly SaaS subscription or one lost business day reframes it as obvious, not expensive.
**Evidence to pull:** $3K audit deliverable table from agency-offer.md — $15K value delivered.
**Credibility tie:** "We've run this 300+ times. We've never had to give the money back."
...
### Take 14 — Most Business Owners Are Managing Their Operations in Their Head

**Hook:** "The most dangerous place to store your business's operating knowledge is inside one person's head."
**Underlying POV:** Key-person dependency is an operational risk. When the owner (or one key manager) holds all the process knowledge, the business can't scale, can't be sold, and breaks when that person leaves. Systems externalise that knowledge.
**Evidence to pull:** Common audit finding across all industries.
**Credibility tie:** "I see this in almost every audit — the 'system' is the owner. That's not a system."

---

## Opinion Trigger Data

Use these stats to anchor hot takes. Update with fresh research in step-01 when a Reputation slot is assigned.

| Stat | Source | Use For |
|------|--------|---------|
| HubSpot share price decline (40%+ from 2021 peak) | Public market data | Take 07 — SaaS valuation signal |
...
## Voice Guidance — Reputation Scripts vs BOFU Scripts

| Dimension | BOFU Script | Reputation Script |
|-----------|-------------|-------------------|
| **Primary goal** | Drive CTA click / keyword comment | Build authority, trust, recognisability |
| **Opening move** | Problem interrupt or pain reveal | Strong opinion, surprising stat, or contrarian claim |
| **Body structure** | Pain → consequence → bridge → CTA | Claim → evidence → implication → (optional) perspective prompt |
| **CTA** | Hard keyword (AUDIT / WASTE / AI) | None required. Soft: "Has this been your experience?" or "Drop YES if you agree." |
| **Tone** | Business operator who's been in their shoes | Confident industry voice — informed, direct, sometimes contrarian |
| **Mention of offer?** | Yes — always bridges to audit | No — never pitch. Authority earns the trust that BOFU scripts convert |
| **Numbers** | Client metrics, savings, project counts | Industry stats, market data, credibility anchors |
| **Danger zone** | Being too generic or feature-listing | Coming across as a lecture or a soft pitch in disguise |
| **Emotional target** | Fear + frustration (loss aversion) | Respect + curiosity (authority recognition + learning signal) |

---

## Reputation CTA Options

| Option | When to Use |
|--------|------------|
| No CTA — end on the point | Default for strong takes that land without prompting |
| "Has this been your experience?" | When the take is relatable and invites business owners to self-identify |
| "Drop YES if you agree." | For takes with broad consensus (tech lag, project failure) |
| "What's the most expensive tool in your stack that you'd kill if you could?" | Engagement bait — only for SaaS/pricing takes |
| "Curious what you've seen — let me know in the comments." | Conversational close for nuanced topics |

**NEVER use a keyword CTA (AUDIT / WASTE / AI / RESULTS) on a Reputation script.** That collapses the brand-building value and turns it into a BOFU script.
