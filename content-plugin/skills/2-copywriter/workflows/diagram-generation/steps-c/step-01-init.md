...
`{project-root}/context/context/brand-assets/reference-frames/catalog.yaml`
...
- `{ref_frames_root}` — `{project-root}/context/context/brand-assets/reference-frames/`
...
So a reference frame at `context/brand-assets/reference-frames/claude-code/file.png` would be referenced in the HTML as:
`{ref_path_prefix}context/brand-assets/reference-frames/claude-code/file.png`
