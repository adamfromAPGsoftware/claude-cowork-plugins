...
Load `{project-root}/_bmad/ccs/data/adam-voice-library.md` immediately. Apply the Written Content Adaptations and Anti-AI Red Flags sections to all blog and email drafts generated in this workflow. Run anti-AI scan before presenting any output to the user.
