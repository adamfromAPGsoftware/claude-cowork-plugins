...
Load `{project-root}/context/references/brand-voice.md` immediately. Apply the Written Content Adaptations and Anti-AI Red Flags sections to all LinkedIn drafts generated in this workflow. Run anti-AI scan before presenting any output to the user.
