...
Keywords MUST be selected from the centralised library at `{project-root}/_bmad/ccs/data/lead-magnet-keywords.yaml`. Do not invent new keywords. Pick the keyword that best matches the post's topic from the 50 pre-registered options.
