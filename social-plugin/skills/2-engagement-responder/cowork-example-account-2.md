---
name: cowork-example-account-2
description: Poll-and-respond cycle for @{YOUR_HANDLE} only. Designed for scheduled Cowork execution via Desktop Commander.
menu-code: FS
---

# Full Cycle: Poll and Respond (@{YOUR_HANDLE})

This is a self-contained, zero-context workflow for scheduled Cowork execution. It polls the @{YOUR_HANDLE} Instagram account for new DMs and comments, then generates and sends responses using each account's conversation strategy. Everything runs through Desktop Commander.
...
This workflow processes ONLY the **apgsoftware** account. No discovery needed.

Set account_key = example-account and proceed directly to Step 2.

---

## Step 2: Process @{YOUR_HANDLE}
...
After processing @{YOUR_HANDLE}, output a structured summary:
